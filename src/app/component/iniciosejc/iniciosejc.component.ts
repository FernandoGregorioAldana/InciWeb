...
@Component({
  selector: 'app-iniciosejc',
  templateUrl: './iniciosejc.component.html',
  styleUrls: ['./iniciosejc.component.css']
})
export class IniciosejcComponent {
  ...
  nos llevara directamente a la pagina de inicio de la plataforma  para jefes de carrera*/
  onbutton(){
    this.userService.login(this.formlog.value)
    .then(() => {
      this.showsucces();
      this.router.navigate(['Iniciojc']);
    })
