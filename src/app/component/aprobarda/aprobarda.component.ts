...
@Component({
  selector: 'app-aprobarda',
  templateUrl: './aprobarda.component.html',
  styleUrls: ['./aprobarda.component.css']
})
export class AprobardaComponent implements OnInit{
...
'fechaSolicitada','fechaSolicitud','actions','firmaJI','firma','firmaSB', 'motRechazo'];
...
constructor(private userService: UserService, private router:Router, 
            ...
            ngOnInit(){
              ...
              const filePath = `Firmas/firmaSubdirec_${id}`;
